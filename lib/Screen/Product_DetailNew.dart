      ...
      child: Padding(
        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
            ...
            color: Color(0XFFE6FFD2),
          ),
          child: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Image.asset(
              'assets/images/categories/Icon ionic-ios-share-alt.png',
              width: 13.0,
              color: Theme.of(context).colorScheme.primarytheme,
            ),
          ),
                    ...
                    Text(
                        ...
                        widget.saleIndex != null
                            ? dataModel.saleList[widget.saleIndex!].status ==
                                    "1"
                                ? "| MRP: ${model.saleDis!}% ${getTranslated(context, 'OFF_LBL')}"
                                : "| MRP: ${off.toStringAsFixed(2)}% ${getTranslated(context, 'OFF_LBL')}"
                            : model.isSalesOn == "1"
                                ? "| MRP: ${model.saleDis!}% ${getTranslated(context, 'OFF_LBL')}"
                                : "| MRP: ${off.toStringAsFixed(2)}% ${getTranslated(context, 'OFF_LBL')}",
                        // : "",
                      ...
                      children: <Widget>[
                        ...
                        productList.isNotEmpty
                            ? Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                                  getTranslated(context, 'Related Products')!,
          ...
          data.attributeList!.isEmpty
              ? data.availability != "0"
                  ? Container(
                      ...
                      child:
                          // data.prVarientList![0].cartCount! != "0"
          ...
          child: Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color: index == 1 ? Colors.grey.shade400 : Colors.green,
                ),
                child: const Padding(
...
/* Future getProductFaqs() async {
  ...
  Future<void> getProductDetails() async {
    ...
    if (_isNetworkAvail) {
      try {
        var parameter = {"product_ids": widget.id, ISDETAILEDDATA: '1'};
